...
export * from './main/main-item-right/main-item-right.component';
export * from './main/main-item-left/main-item-left.component';
...
export * from './button-img-hover/button-img-hover.component';
